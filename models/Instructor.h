...
class Instructor
{
  public:
     ...
     */
    explicit Instructor(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Instructor(const Json::Value &pJson) noexcept(false);
     ...
     */
    Instructor(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    Instructordetail getInstructordetail(const drogon::orm::DbClientPtr &clientPtr) const;
    void getInstructordetail(const drogon::orm::DbClientPtr &clientPtr,
                             const std::function<void(Instructordetail)> &rcb,
                             const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<Course> getCourse(const drogon::orm::DbClientPtr &clientPtr) const;
    void getCourse(const drogon::orm::DbClientPtr &clientPtr,
                   const std::function<void(std::vector<Course>)> &rcb,
                   const drogon::orm::ExceptionCallback &ecb) const;
  private:
    friend drogon::orm::Mapper<Instructor>;
    friend drogon::orm::BaseBuilder<Instructor, true, true>;
    friend drogon::orm::BaseBuilder<Instructor, true, false>;
    friend drogon::orm::BaseBuilder<Instructor, false, true>;
    friend drogon::orm::BaseBuilder<Instructor, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Instructor>;
#endif
