...
namespace app_helpers::crypto_helper{
    ...
    try
    {
        ...
        string token = "632c4dfa61af1dd6ca5b80f3152d6a6f3c4a8b0fda39fa2a4945e7a7c775110e";
    ...
    {
        return boost::algorithm::to_lower_copy(encrypt(rawPassword)).compare(boost::algorithm::to_lower_copy(hashPassword)) == 0;
    }
}